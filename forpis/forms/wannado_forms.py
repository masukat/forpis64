...
from ..models.wannado_models import WannaDo,WannaDo_motivation,WannaDo_genre1,WannaDo_genre2,WannaDo_deadline

class WannaDoForm(forms.ModelForm):
    class Meta:
        model = WannaDo
        fields = ['done','motivation','review','genre1','genre2','plan','urllink','tag1','tag2','tag3','travelhour','travelmin','completiondate','deadline']
